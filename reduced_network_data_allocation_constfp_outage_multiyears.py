        ...
        for NN in NODE_NUMBER:
            ...
            for UC in UC_TREATMENTS:
                ...
                for T_p in trans_p:
                    ...
                    path=str(Path.cwd()) + str(Path('/Exp' + str(NN) + UC + '_' + str(T_p) + '_' + str(y) + '_' + str(section)))
                    ...
                    # optional compatibility file during transition
                    df_hydro_hourly.to_csv('nodal_hydro.csv', index=None)
                    ...
                    # Calculating the average price for each bus (column-wise average)
                    Coal_prices_bus_avg = Coal_prices_all.mean(axis=0)
    
                    # Creating a DataFrame where each row contains the average price of each bus, keeping the structure
