# -*- coding: utf-8 -*-
"""
Predict 2016 daily hub prices from Henry Hub using historical ICE data.
...
HENRY_PREV_FILE = '2015_hh.xlsx'
HENRY_TARGET_FILE = '2016_hh.xlsx'

TARGET_YEAR = 2016
EIC_HUBS = ['Algonquin Citygates', 'Chicago Citygates', 'TETCO-M3']

OUTPUT_PREDICTED = 'Predicted_2016.csv'
