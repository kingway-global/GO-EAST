...
states = ['ND','SD','NE','KS','OK','MN','IA','MO','AR','LA','MS','WI','IL','MI','IN','OH','KY','TN','AL','FL','GA','SC','NC','WV','MD','DE','PA','NJ','NY','NH','CT','RI','MA','VT','ME']
...
for state in states:
    print(state,len(state_coal_price[state]))
...
coal_price_final_daily.to_csv('coal_prices_state_2019.csv',index=False)
